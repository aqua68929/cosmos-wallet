...
using CosmosWallet.Core;
using Microsoft.Extensions.Logging;

namespace CosmosWallet.App;
...
internal static class Commands
{
    ...
    {
        Console.WriteLine("cosmoswallet 1.1.0 (.NET 10)");
        return 0;
    }
    ...
    {
        Console.WriteLine("""
            cosmoswallet — local multi-chain vault CLI (lab / simulated I/O)
